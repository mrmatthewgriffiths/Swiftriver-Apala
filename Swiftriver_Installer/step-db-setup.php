...
<?php
    ...
    $welcomeMessage =
             ...
             "here, you should have gone and created a database and a user and given ".
             "that user full rights on the data base . . . if you haven't, go now and do ".
             "it quickly.";

    $errorMessage =
             "There were some issues with the data you entered. Can you check it over ".
             "for me and try again?";

    $finishedMessage =
            "So that wasn't that bad now was it? I think were done here. . .  As I said ".
            "I'm now going to hand you over to my old friend the Ushahidi installer so he ".
            "can walk you though the last bits of the setup . . . then your done! . . . . ".
            "Oh, one last thing before I go . . . In the future, I'll be able to handle all ".
            "the setup tasks so dont think bad of me just yet . . . Thanks and see you on the ".
            "other site, Swiftriver."
