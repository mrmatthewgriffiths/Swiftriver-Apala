...
?>
			...
			<div id="item_panel">	
						<?php if(isset($_SESSION['auth_user'])){ ?>
								<a id="feed_link_<?php echo $feed_id ;?>" href="javascript:increment_feed_rating('<?php echo $feed_id ;?>','<?php echo $feed->sourceid ; ?>')" title="Mark as Accurate" >
						<?php } ?>
			...
			<div style="float:right">
				...
				<!-- See Reverberations -->										
				<!-- <a href="javascript:increment_feed_rating('<?php echo $feed_id ;?>','<?php echo $feed->sourceid ; ?>')" > 
				...
				<a id="reduce_ratting_link_<?php echo $feed_id ;?>" href="javascript:decrement_feed_rating('<?php echo $feed_id ;?>','<?php echo $feed->category_id ; ?>')"  title="Mark as Inaccurate, Falsehood or Biased" > 
				<img src="<?php echo url::base(); ?>/media/img/x_btn.png" alt="<?php echo $feed_title ?>" align="absmiddle" style="border:0" width="18" />
															</a>
				<!-- Mark as Crosstalk -->	
				<a id='irrelevant_link_<?php echo $feed_id ; ?>' href="javascript:mark_irrelevant('<?php echo $feed_id ;?>','<?php echo $feed->sourceid ; ?>')"   title="Mark as Crosstalk"  > 
